...
public class PreProcessorRequestTest {
  @Test
  public void testGetterAndSetters() {
    new BeanTester().testBean(PreProcessorRequest.class);
  }

  @Test
  public void testEqualsAndHashCode(){
    EqualsVerifier.forClass(PreProcessorRequest.class)
  ...
  public void testGenerateMD5(){
    PreProcessorRequest ppr = new PreProcessorRequest();
